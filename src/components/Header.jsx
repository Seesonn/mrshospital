            ...
            >
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="hidden md:block bg-primary rounded-full p-2 mr-3">
                    <svg
                  ...
                  <div>
                    <p className="text-gray-600 text-sm">025-580930</p>
                  </div>
                </div>

                <div className="flex items-center">
                  {/* Address icon - hidden on mobile */}
                  <div className="hidden md:block bg-primary rounded-full p-2 mr-3">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 text-white"
                ...
                <div className="flex items-center">
                  <Link 
                    to="/lab-reports" 
                    className="flex items-center bg-primary hover:bg-secondary rounded-full px-4 py-2 text-white transition-colors duration-300"
                  >
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
              ...
              >
                ...
                >
                  ...
                  <div className="mt-3">
                    <Link 
                      to="/lab-reports" 
                      className="flex items-center justify-center bg-white bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg py-2 px-4 transition-colors duration-300"
                      onClick={() => setIsOpen(false)}
                    >
                      <svg 
                        xmlns="http://www.w3.org/2000/svg" 

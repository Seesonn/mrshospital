            ...
            <div className="hidden md:flex">
              {navLinks.map((link, index) => (
                <button
                  ...
                  className={`px-3 lg:px-4 py-3 md:py-4 text-white transition-colors duration-300 relative group ${
                    currentPath === link.path ? "bg-secondary" : ""
                  }`}
                >
                  <span className="text-sm md:text-base">{link.name}</span>
                  <motion.div
                    className="absolute bottom-0 left-0 right-0 h-1 bg-white"
                    initial={{ scaleX: 0 }}
                    animate={{ scaleX: currentPath === link.path ? 1 : 0 }}
                    exit={{ scaleX: 0 }}
                    transition={{ duration: 0.3, ease: "easeInOut" }}
                  />
                  <motion.div
              ...
              >
                  ...
                  {navLinks.map((link, index) => (
                    ...
                    >
                      <button
                        onClick={() => navigate(link.path)}
                        className={`flex flex-col items-center justify-center p-2 rounded-lg ${
                          currentPath === link.path ? "bg-secondary" : "bg-white bg-opacity-10"
                ...
                >
                  ...
                  <div className="mt-2">
                    <button
                      onClick={() => navigate("/lab-reports")}
                      className="flex items-center justify-center bg-white bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg py-1 px-3 transition-colors duration-300 text-xs w-full"
                    >
                      <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        className="h-3 w-3 mr-1" 
